...
class DanTriFlow:
    ...
    def run(self, *, url: str, context: SiteFlowContext) -> None:
        ...
        with sync_playwright() as playwright:
            ...
            browser = playwright.chromium.launch(headless=context.headless)
            browser_context = browser.new_context()
            page = browser_context.new_page()
            page.set_default_timeout(min(context.timeout_ms, 30000))

            try:
                context.logger.info("Navigating to DanTri url=%s", url)
                ...
                try:
                    ...
                    _type_text(register_name, context.account.name)
                    _type_text(register_email, context.account.email)
                ...
                try:
                    ...
                    _type_text(login_email, context.account.email)
